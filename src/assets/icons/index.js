...
const DeleteIcon =({ onClick }) => {
    return <i onClick={onClick} style={{cursor:'pointer'}} className="ri-delete-bin-6-line"></i>
};

const RevertIcon =({ onClick }) => {
    return <i onClick={onClick} style={{cursor:'pointer'}} className="ri-reset-left-line"></i>
};

export { LogoutIcon, RevertIcon, DeleteIcon };