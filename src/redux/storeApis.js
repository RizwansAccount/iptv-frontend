...
export const iptvApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        // genre Apis
        getAllGenre: builder.query({ query: (search) => ({ url: `genres?search=${search}` }), providesTags: () => [TAG_TYPES.genre], transformResponse: (res) => res?.data }),
        ...
        //series Apis
        getAllSeries: builder.query({ query: (search) => ({ url : `series?search=${search}` }), providesTags: ()=> [TAG_TYPES.series], transformResponse: (res) => res?.data }),
        ...
        //season apis
        getAllSeasons: builder.query({ query:(search)=> ({ url: `seasons?search=${search}` }), providesTags:()=> [TAG_TYPES.season], transformResponse: (res) => res?.data }),
